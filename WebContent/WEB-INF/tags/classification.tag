...
<%@ attribute name="classificationType" required="true" %>
...
<%  
	...
	String classification = classificationType;
	...
	while (iterator.hasNext()) 
	{
		...
		// Check if the given classification car type is equals to current taxi car
		if (classification.equals(taxiCar.getTaxiClassification())) 
		{		
%>
			...
			<div class="footer">
				<button type="submit" id="<%=taxiCar.getTaxiPlateNumber()%>" 
					class="btn btn-info btn-s">Add To Favorites</button>
			</div>
		</li>
<% 
	  }
