...
<html>
	...
	<body>
		...
		<div id="column_w800">
			...
			<!-- Title -->
			<div class="header_02">Delete taxi companies</div>
				<p>Delete taxi companies from TaxiToGo database</p>
	...
	%>
		...
		<div class="body body-s">
			...
			<form id="sky-form" class="sky-form">
				...
				<!-- Delete button -->
				<footer>
					<button type="submit" class="button" id="deletebutton">Delete</button>
				</footer>
			</form>
		</div>
		...
		<script type="text/javascript" src="<%=context%>/js/admin_company_delete_ajax.js"></script>
	</body>
</html>