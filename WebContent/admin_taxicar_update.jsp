...
<html>
	...
	<body>
		...
		<div id="column_w800">
			...
			<!-- Title -->
			<div class="header_02">Update taxi cars and drivers</div>
				...
				<fieldset>
					...
					<section>
						<label class="input"> <i class="icon-append fa fa-user"></i>
							<input type="text" name="drivername" id="drivername" placeholder="Driver full name">
						</label>
					</section>
					...
					<section>
						<label class="input"> <i class="icon-append fa fa-clock-o"></i>
							<input type="text" name="workinghours" id="workinghours" placeholder="End shift">
						</label>
					</section>
				</fieldset>
		...
		<script type="text/javascript" src="<%=context%>/js/admin_taxicar_update_ajax.js"></script>
		<script type="text/javascript" src="<%=context%>/js/jquery.maskedinput.min.js"></script>			
	</body>
</html>